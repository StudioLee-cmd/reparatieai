...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Een klant belt over een wasmachine die niet meer centrifugeert; de agent vraagt naar merk en foutcode en plant de reparateur in.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Iemand wil de reparatie-afspraak verzetten omdat ’ie die dag niet thuis is.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een klant vraagt ’s avonds of repareren nog loont of dat vervangen slimmer is.',
        stem: 'Eva',
        src: null,
        duur: null,
    },
