...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor reparatiebedrijven" }, { href: "/chatbot", anchor: "ai chatbot voor reparatiebedrijven" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor reparatiebedrijven" }, { href: "/reviews", anchor: "review management voor reparatiebedrijven" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor reparateurs" }, { href: "/crm", anchor: "crm voor reparatiebedrijven" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor reparatiebedrijven" }],
    }
];
