...
const niche = siteDetails.niche?.toLowerCase() || "reparateurs";
...
const workflows = [
  ...
  },
  {
    ...
    desc: `Klantspecifieke onderhoud- of opvolg-cycli automatisch beheerd. Voor Reparateurs: automatische statusupdate bij reparatievoortgang, klaarmelding via WhatsApp/SMS bij gerepareerd apparaat, review-verzoek na ophalen apparaat — terugkerende omzet zonder dat jij eraan hoeft te denken.`,
  },
];
...
const integrations = [
  { icon: BsWhatsapp, title: "WhatsApp Business", desc: "Het hoofdkanaal — 90% van reparateurs-klanten checkt WhatsApp sneller dan e-mail." },
